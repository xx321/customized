...
public class InitServiceImpl implements InitServiceI {
	...
	synchronized public void init() {
		...
		initBugType();// 初始化BUG類型

		initResourceType();// 初始化資源類型
	...
	private void initResource() {
		Tresourcetype menuType = resourceTypeDao.get(Tresourcetype.class, "0");// 選單類型
		Tresourcetype funType = resourceTypeDao.get(Tresourcetype.class, "1");// 功能類型
		...
		yhglBatchDelete.setName("批量刪除用戶");
		...
		yhglEditPwdPage.setName("用戶修改密碼頁面");
		...
		userCreateDatetimeChart.setName("用戶圖表");
