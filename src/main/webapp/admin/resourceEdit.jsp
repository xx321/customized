		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th>資源名稱</th>
					<td><input name="name" type="text" placeholder="请输入資源名稱" class="easyui-validatebox span2" data-options="required:true" value="${resource.name}"></td>
				</tr>
				<tr>
					<th>資源路徑</th>
					<td><input name="url" type="text" placeholder="请输入資源路徑" class="easyui-validatebox span2" value="${resource.url}"></td>
					<th>資源類型</th>
