...
<div id="roleGrantLayout" class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'west'" title="系統資源" style="width: 300px; padding: 1px;">
	...
	<div data-options="region:'center'" title="" style="overflow: hidden; padding: 10px;">
		...
		<div class="well well-large">
			<button class="btn btn-success" onclick="checkAll();">全選</button>
			<br /> <br />
			<button class="btn btn-warning" onclick="checkInverse();">反選</button>
			<br /> <br />
