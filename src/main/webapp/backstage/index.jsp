...
<body>
	...
	<jsp:include page="../user/login.jsp"></jsp:include>	<!-- 使用者登錄表單 -->
	<jsp:include page="../user/reg.jsp"></jsp:include>		<!-- 使用者註冊表單 -->

	<div id="index_layout">
		<div data-options="region:'north',href:'${pageContext.request.contextPath}/layout/north.jsp'" style="height: 40px; overflow: hidden;" class="logo"></div>
		<div data-options="region:'west',href:'${pageContext.request.contextPath}/layout/west.jsp',split:true" title="導航模塊" style="width: 180px; overflow: hidden;"></div>
		<div data-options="region:'center'" title="歡迎使用客制化系統後台" style="overflow: hidden;">
			<div id="index_tabs" style="overflow: hidden;">
				<div title="首頁" data-options="border:false" style="overflow: hidden;">
					<iframe src="${pageContext.request.contextPath}/portal/index.jsp" style="border: 0; width: 100%; height: 98%;frameborder: 0;"></iframe>
				</div>
			</div>
		</div>
